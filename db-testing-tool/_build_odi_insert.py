...
EXPR_OVERRIDES = {
    ...
    "OWN_FA_ENT_RTL_SALE_HIER_LOB_CD":    "NULL",
    "OWN_FA_ENT_RTL_SALE_HIER_LOB_DSC":   "NULL",
    "OWN_FA_ENT_RTL_HIER_RPT_UNIT_CD":    "NULL",
    "OWN_FA_ENT_RTL_HIER_RPT_UNIT_DSC":   "NULL",
    "OWN_FA_ENT_RTL_SALE_DIV_CD":         "NULL",
    "OWN_FA_ENT_RTL_SALE_HIER_RGON_CD":   "NULL",
    "OWN_FA_ENT_RTL_SALE_HIER_RGON_DSC":  "NULL",
    "OWN_FA_ENT_RTL_HIER_TERR_CD":        "NULL",
    "OWN_FA_ENT_RTL_HIER_TERR_DSC":       "NULL",
    "OWN_FA_ENT_RTL_SALE_CPX_CD":         "NULL",

    # OWN_RISK_ENT cols -- ENTITY_RISK_* cols do not exist on ENTERPRISE_ENTITY_DIM_V
    "OWN_FA_ENT_RSK_HIER_BSN_UNIT_CD":    "NULL",
    "OWN_FA_ENT_RSK_HIER_BSN_UNIT_DSC":   "NULL",
